/obj/item/clothing/head/helmet/space/void/pilot/vista
	name = "exosuit operator helmet"
	desc = "An abraised voidsuit helmet usually issued to exosuit fighters of SCG cavalry division. There is a white title saying ''Wingman'' on the side."
