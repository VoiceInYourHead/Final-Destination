...
/*/datum/map/proc/build_junkyards()
	...
	for(var/i = 0, i < num_junkyards, i++)
		var/junkyard_type = pick(subtypesof(/obj/effect/overmap/visitable/sector/junkyard))
		var/obj/effect/overmap/visitable/sector/junkyard/new_junkyard = new junkyard_type(null, planet_size[1], planet_size[2])
