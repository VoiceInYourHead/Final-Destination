...
/datum/map/proc/build_junkyards()
	...
	for(var/i = 0, i < num_junkyards, i++)
		var/list/junkyard_types_to_pick = subtypesof(/obj/effect/overmap/visitable/sector/junkyard)
		var/junkyard_type = pick(junkyard_types_to_pick)
		var/obj/effect/overmap/visitable/sector/junkyard/new_junkyard = new junkyard_type(null, junkyard_size[1], junkyard_size[2])
