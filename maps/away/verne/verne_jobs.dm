...
/datum/job/submap/CTI_Undergraduate_Xenoscience_Researcher
	...
	to find the Verne running at low capacity, under-staffed, with much of the automated life support systems doing the heavy lifting."
	whitelisted_species = list(SPECIES_HUMAN,SPECIES_SPACER,SPECIES_GRAVWORLDER,SPECIES_VATGROWN,SPECIES_TRITONIAN,SPECIES_DIONA,SPECIES_IPC,SPECIES_UNATHI,SPECIES_NABBER)
	required_language = LANGUAGE_HUMAN_EURO
	min_skill = list(
...
/datum/job/submap/CTI_professor
	title = "CTI Professor"
	supervisors = "the CTI itself"
	total_positions = 1
	outfit_type = /decl/hierarchy/outfit/job/verne/researcher/head
	info = "You are an CTI professor on the SRV Verne, alongside the rest of your class of the prestigious Ceti Technical Institute conducting research \
	in the depths of space. Protect the students; and assist in their studies. Your team has awoken \
	to find the Verne running at low capacity, under-staffed, with much of the automated life support systems doing the heavy lifting."
	whitelisted_species = list(SPECIES_HUMAN,SPECIES_SPACER,SPECIES_GRAVWORLDER,SPECIES_VATGROWN,SPECIES_TRITONIAN,SPECIES_IPC)
	required_language = LANGUAGE_HUMAN_EURO
	min_skill = list(
		SKILL_BUREAUCRACY = SKILL_BASIC,
...
/decl/hierarchy/outfit/job/verne/researcher/head
	name = VERNE_OUTFIT_JOB_NAME("CTI Professor")
