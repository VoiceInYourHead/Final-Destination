#define WEBHOOK_SUBMAP_LOADED_ASCENT_GUNBOAT "webhook_submap_ascent_gunboat"

// Submap datum and archetype.
/decl/webhook/submap_loaded/ascent_gunboat
	id = WEBHOOK_SUBMAP_LOADED_ASCENT_GUNBOAT

/decl/submap_archetype/ascent_gunboat
	descriptor = "Ascent Gunboat"
	map = "Ascent Gunboat"
...
/datum/submap/ascent_gunboat
	var/gyne_name

/datum/submap/ascent_gunboat/sync_cell(obj/effect/overmap/visitable/cell)
	return
...
/datum/job/submap/ascent_gunboat/handle_variant_join(var/mob/living/carbon/human/H, var/alt_title)
	...
	var/datum/submap/ascent_gunboat/cutter = owner
	if(!istype(cutter))
...
/obj/effect/submap_landmark/spawnpoint/ascent_gunboat
	name = "Ascent Alate Soldier"
