...
#define HOME_SYSTEM_MEOTOURNE  "Meotourne"
#define HOME_SYSTEM_REPUBLIC   "Nova Respublica"
...
#define CULTURE_HUMAN_MEOTOURNE	"Meonian"
#define CULTURE_HUMAN_REPUBLIC	"Republican"
