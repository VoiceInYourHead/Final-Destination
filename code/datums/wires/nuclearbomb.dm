/datum/wires/nuclearbomb
	...
	wire_count = 7
	descriptions = list(
		new /datum/wire_description(NUCLEARBOMB_WIRE_LIGHT, "This wire seems to connect to the small light on the device.", SKILL_MASTER),
		new /datum/wire_description(NUCLEARBOMB_WIRE_TIMING, "This wire connects to the time display.", SKILL_MASTER),
		new /datum/wire_description(NUCLEARBOMB_WIRE_SAFETY, "This wire connects to a safety override.", SKILL_MASTER)
	)
