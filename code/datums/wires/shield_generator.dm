/datum/wires/shield_generator
	...
	descriptions = list(
		...
		new /datum/wire_description(SHIELDGEN_WIRE_HACK, "This wire seems designed to enable a manual override.", SKILL_EXPERIENCED),
		new /datum/wire_description(SHIELDGEN_WIRE_CONTROL, "This wire connects to the main control panel."),
		new /datum/wire_description(SHIELDGEN_WIRE_AICONTROL, "This wire connects to automated control systems.", SKILL_EXPERIENCED)
	)
