/datum/wires/alarm
	...
	descriptions = list(
		...
		new /datum/wire_description(AALARM_WIRE_SYPHON, "This wire runs to atmospherics logic circuits of some sort.", SKILL_EXPERIENCED),
		new /datum/wire_description(AALARM_WIRE_AI_CONTROL, "This wire connects to automated control systems.", SKILL_EXPERIENCED),
		new /datum/wire_description(AALARM_WIRE_AALARM, "This wire gives power to the actual alarm mechanism.", SKILL_EXPERIENCED)
	)
