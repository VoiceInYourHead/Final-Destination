/datum/wires/radio
	...
	wire_count = 3
	descriptions = list(
		new /datum/wire_description(WIRE_SIGNAL, "This wire connects several radio components.", SKILL_EXPERIENCED),
		new /datum/wire_description(WIRE_RECEIVE, "This wire runs to the radio reciever.", SKILL_EXPERIENCED),
		new /datum/wire_description(WIRE_TRANSMIT, "This wire runs to the radio transmitter.", SKILL_EXPERIENCED)
	)
