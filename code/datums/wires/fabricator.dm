...
/datum/wires/fabricator
	...
	wire_count = 6
	descriptions = list(
		new /datum/wire_description(AUTOLATHE_HACK_WIRE, "This wire appears to lead to an auxiliary data storage unit.", SKILL_MASTER),
		new /datum/wire_description(AUTOLATHE_SHOCK_WIRE, "This wire seems to be carrying a heavy current.", SKILL_EXPERIENCED),
