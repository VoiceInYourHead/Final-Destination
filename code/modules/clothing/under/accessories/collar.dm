/obj/item/clothing/accessory/necklace/collar
	...
	icon = 'icons/infinity/obj_accessories.dmi'
	icon_state = "collar_bksilv"

	accessory_icons = list(
		slot_w_uniform_str = 'icons/infinity/onmob_accessories.dmi', \
		slot_wear_suit_str = 'icons/infinity/onmob_accessories.dmi')
	item_icons = list(
		slot_wear_mask_str = 'icons/infinity/onmob_accessories.dmi')
