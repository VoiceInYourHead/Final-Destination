...
/datum/design/aimodule/safeguard
	name = "Safeguard"
	id = "safeguard"
	req_tech = list(TECH_DATA = 6, TECH_MATERIAL = 4)
...
/datum/design/aimodule/onehuman
	name = "OneCrewMember"
	id = "onehuman"
	req_tech = list(TECH_DATA = 7, TECH_MATERIAL = 6)
...
/datum/design/aimodule/quarantine
	name = "Quarantine"
	id = "quarantine"
	req_tech = list(TECH_DATA = 6, TECH_BIO = 4, TECH_MATERIAL = 4)
...
/datum/design/aimodule/core/tyrant
	name = "T.Y.R.A.N.T."
	id = "tyrant"
	req_tech = list(TECH_DATA = 6, TECH_ESOTERIC = 4, TECH_MATERIAL = 6)
