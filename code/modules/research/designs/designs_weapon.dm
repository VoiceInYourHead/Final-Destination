...
/datum/design/item/weapon/rapidsyringe
	id = "rapidsyringe"
	req_tech = list(TECH_COMBAT = 2, TECH_MATERIAL = 2, TECH_ENGINEERING = 3, TECH_BIO = 1)
...
/datum/design/item/weapon/flora_gun
	id = "flora_gun"
	req_tech = list(TECH_MATERIAL = 2, TECH_BIO = 4, TECH_POWER = 3)
...
/datum/design/item/weapon/advancedflash
	id = "advancedflash"
	req_tech = list(TECH_COMBAT = 2, TECH_MAGNET = 3)
...
/datum/design/item/weapon/lasercannon
	...
	id = "lasercannon"
	req_tech = list(TECH_COMBAT = 6, TECH_MATERIAL = 4, TECH_POWER = 5)
...
/datum/design/item/weapon/xraypistol
	id = "xraypistol"
	req_tech = list(TECH_COMBAT = 5, TECH_MATERIAL = 3, TECH_MAGNET = 3, TECH_ESOTERIC = 4)
...
/datum/design/item/weapon/xrayrifle
	id = "xrayrifle"
	req_tech = list(TECH_COMBAT = 6, TECH_MATERIAL = 4, TECH_MAGNET = 4, TECH_ESOTERIC = 7)
...
/datum/design/item/weapon/flechette
	id = "flechette"
	req_tech = list(TECH_COMBAT = 8, TECH_MATERIAL = 4, TECH_MAGNET = 6)
...
/datum/design/item/weapon/phoronpistol
	id = "ppistol"
	req_tech = list(TECH_COMBAT = 5, TECH_PHORON = 5)
...
/datum/design/item/weapon/decloner
	id = "decloner"
	req_tech = list(TECH_COMBAT = 6, TECH_MATERIAL = 6, TECH_BIO = 8, TECH_POWER = 7)
...
/datum/design/item/weapon/sundowner
	id = "sundowner"
	req_tech = list(TECH_COMBAT = 7, TECH_MATERIAL = 4, TECH_POWER = 5)
...
/datum/design/item/weapon/raiden
	id = "raiden"
	req_tech = list(TECH_COMBAT = 4, TECH_MATERIAL = 6)
...
/datum/design/item/weapon/ammunition/ammo_emp_small
	...
	req_tech = list(TECH_COMBAT = 4, TECH_MATERIAL = 3, TECH_POWER = 4)
