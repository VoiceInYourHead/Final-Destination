...
/datum/design/item/implant/death_alarm
	name = "death alarm"
	id = "implant_death"
	req_tech = list(TECH_MATERIAL = 2, TECH_BIO = 5, TECH_DATA = 2)
...
/datum/design/item/implant/tracking
	name = "tracking"
	id = "implant_tracking"
	req_tech = list(TECH_MATERIAL = 2, TECH_BIO = 5, TECH_BLUESPACE = 3)
...
/datum/design/item/implant/imprinting
	...
	req_tech = list(TECH_MATERIAL = 2, TECH_BIO = 8, TECH_DATA = 6)
...
/datum/design/item/implant/explosive
	...
	req_tech = list(TECH_MATERIAL = 4, TECH_BIO = 3, TECH_ESOTERIC = 6)
