...
/obj/structure/closet/crate/secure/loot/proc/generate_loot()
	...
	switch(loot)
		...
		if(101)
			new/obj/item/fd/ancient_items/psionic(src)
		if(102)
			new/obj/item/fd/ancient_items/zippo(src)
		if(103)
			new/obj/item/fd/ancient_items/corrupted_radio(src)
		if(104)
			new/obj/item/fd/ancient_items/energy_container(src)
		if(105)
			new/obj/item/fd/ancient_items/teddy_bear(src)
		if(106)
			new/obj/item/fd/ancient_items/gold_necklace(src)
		if(107)
			new/obj/item/fd/ancient_items/jap_neko(src)
		if(108)
			new/obj/item/fd/ancient_items/starmap(src)
		if(109)
			new/obj/item/fd/ancient_items/phone(src)
		if(110)
