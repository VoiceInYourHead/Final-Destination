...
/datum/admins/proc/show_player_panel(var/mob/M in SSmobs.mob_list)
	...
	if(isliving(M))
		...
		for(var/faculty in list(PSI_COERCION, PSI_CONSCIOUSNESS, PSI_PSYCHOKINESIS, PSI_MANIFESTATION, PSI_CRYOKINESIS, PSI_ENERGISTICS, PSI_METAKINESIS, PSI_REDACTION))
