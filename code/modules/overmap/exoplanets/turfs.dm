...
/turf/unsimulated/floor/exoplanet/New()
	...
	if(GLOB.using_map.use_overmap)
		...
		if(istype(E,/obj/effect/overmap/visitable/sector/exoplanet/urban))
			...
			if(istype(src.loc,/area/psionic_school/outdoor))
				set_light(0.3, 0.1, 2, 0, l_color = "#e2d1b2")
...
/turf/unsimulated/floor/exoplanet/water/Entered(mob/living/L)
	..()
	if(istype(L))
		L.update_water_overlay()

/turf/unsimulated/floor/exoplanet/water/Exited(mob/living/L)
	..()
	if(istype(L))
		L.update_water_overlay()
