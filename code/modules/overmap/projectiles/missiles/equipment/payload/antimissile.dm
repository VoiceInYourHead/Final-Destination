...
*/
/obj/item/missile_equipment/payload/antimissile/do_overmap_work(var/obj/effect/overmap/visitable/projectile/P)
	if(!..())
		return

	var/turf/T = get_turf(P)
	for(var/obj/effect/overmap/visitable/projectile/O in T)
		if(O == P)
			continue
