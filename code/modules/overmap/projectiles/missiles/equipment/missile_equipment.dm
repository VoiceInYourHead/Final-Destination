...
/obj/item/missile_equipment/proc/on_missile_activated(var/obj/effect/overmap/missile/P)
	return

// Called when the overmap projectile processes
/obj/item/missile_equipment/proc/do_overmap_work(var/obj/effect/overmap/missile/P)
...
/obj/item/missile_equipment/proc/on_touch_map_edge(var/obj/effect/overmap/missile/P)
	return
