...
/datum/overmap_contact
	...
	var/obj/machinery/computer/ship/sensors_passive/owner

	// The actual overmap effect associated with this.
	var/obj/effect/overmap/effect

/datum/overmap_contact/New(var/obj/machinery/computer/ship/sensors_passive/creator, var/obj/effect/overmap/source)
