...
/datum/sprite_accessory/marking/shell/spirit_lights_body
	name = "Ward - Spirit FBP Lights (body)"
	icon_state = "lights"
	body_parts = list(BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_L_HAND,BP_R_HAND,BP_CHEST)

/datum/sprite_accessory/marking/shell/spirit_panels_head
	name = "Ward - Spirit FBP Lights (head)"
	icon_state = "lights"
	body_parts = list(BP_HEAD)

/datum/sprite_accessory/marking/shell/spirit_panels
...
/datum/sprite_accessory/marking/shell/spirit_panels_body
