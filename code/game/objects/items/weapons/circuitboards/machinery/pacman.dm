...
/obj/item/stock_parts/circuitboard/pacman/super/potato/reactor/vox
	name = T_BOARD("ICRER-2-V nuclear generator")
	build_path = /obj/machinery/power/port_gen/pacman/super/potato/reactor/vox
	origin_tech = list(TECH_DATA = 3, TECH_POWER = 5, TECH_ENGINEERING = 4)
