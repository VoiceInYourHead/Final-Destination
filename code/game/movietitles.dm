	...
	if(mob)
		...
		if(mob.get_preference_value(/datum/client_preference/play_lobby_music) == GLOB.PREF_YES)
			...
			if(GLOB.end_credits_song == null)
				var/title_song = pick('sound/music/THUNDERDOME.ogg', 'sound/music/finaldestination/roundEnd.ogg', 'sound/music/finaldestination/SmashIntoPieces_AllEyesOnYou.ogg', 'sound/music/finaldestination/WarsofExpansion.ogg')
